...
class MerchantController extends Controller
{
    public function merchantAccountFirstStep()
    {
        ...
        $states = State::all();
        $cities = City::all();
        return view('frontend.all-page.merchant_account_first_step',compact('states','cities','countries'));
    }
    public function merchantAccountSecondStep(Request $request)
    {
        ...
        return view('frontend.all-page.merchant_account_second_step', compact('delivery_options'));
    }
