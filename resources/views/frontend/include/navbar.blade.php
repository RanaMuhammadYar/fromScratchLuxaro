    ...
    <div class="logos-header py-2">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <a class="logo-gold" href="javascript:void"><img src="images/GoldEvine-logo.png" class="img-fluid"></a>
                <a class="logo" href="javascript:void"><img src="images/logo.png" class="img-fluid"></a>
                <a class="logo-gold" href="javascript:void"><img src="images/Gold-Metal-logo.png" class="img-fluid"></a>
            </div>
        </div>
    </div>
            ...
            <div class="header-row d-flex justify-content-between align-items-center">
                ...
                <div class="header-info d-flex justify-content-between align-items-center px-3">
                    ...
                    <ul class="list-unstyled text-uppercase d-flex m-0 p-0">
                        ...
                        <li class="ms-3 cart-icon"><a href="javascript:void"><i class="fa fa-shopping-cart"
