            ...
            <div>
                <div class="product-item">
                    <a href="{{ route('productDetails', ['id' => $locallaxar->id, 'slug' => Str::slug($locallaxar->product_name)]) }}">
                        <div class="img-holder">
                            <img src="{{ $locallaxar->image }}" onerror="this.src='{{ asset('images/default.png') }}'" class="img-fluid">
                        </div>
                    </a>
                    <div class="txt-holder">
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                <a href="{{ route('productDetails', ['id' => $locallaxar->id, 'slug' => Str::slug($locallaxar->product_name)]) }}" style="color:black">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn bg-dark text-white py-1 px-2" href="" onclick="addToCart('{{ $locallaxar->id }}', '{{ $locallaxar->product_name }}', '{{ $locallaxar->product_price }}')"><i class="fa fa-shopping-basket"></i>
                            </button>
