                                ...
                                <div class="product-item">
                                    ...
                                    <div class="txt-holder">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button class="btn bg-dark text-white py-1 px-2" onclick="addToCart('{{ $relatedProduct->id }}', '{{ $relatedProduct->product_name }}', '{{ $relatedProduct->product_price }}')"><i class="fa fa-shopping-basket"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
