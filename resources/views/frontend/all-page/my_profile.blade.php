                        ...
                        <div class="my-account-section">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="about-me border rounded pincel">
                                            <input type="text" class="form-control" name="about_me" id="about_me" value="{{@$user->about_me}}">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" class="form-control" name="country_id" id="country_id">
                                            ...
                                            <option value="{{$country->id}}" {{ (isset($user)) ? $country->id == $user->country ? 'selected' : '' : '' }}>{{$country->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="row gx-2 mb-0 mb-md-3">
                                        ...
                                        <div class="col-12 col-md-6 mb-3 mb-md-0">
                                            ...
                                            <input type="text" class="form-control mt-2" name="postal_code" value="{{@$user->postal_code}}">
                                            <div class="pincel"></div>
                                        </div>
                                    </div>
                                    <div class="row gx-2 mb-0 mb-md-3">
                                    ...
                                    <div class="row gx-4 mb-0 mb-md-5 align-items-end">
                                        <div class="col-12 col-md-8 mb-3 mb-md-0">
                                            ...
                                            <select class="form-select" name="language">
                                                <option></option>
                                                <option value="english" {{ ("english" == @$user->language) ? 'selected' : '' }}>English</option>
                                                <option value="spanish" {{ ("spanish" == @$user->language) ? 'selected' : '' }}>Spanish</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <div class="input-icon">
                                                <input type="date" class="book_from form-control" name="book_from" value="{{@$user->book_from}}" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <label for="book_to">To</label>
                                            <div class="input-icon"><input type="date" class="book_to form-control" name="book_to" value="{{@$user->book_to}}" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <div class="input-icon"><input type="text" name="college_name" value="{{@$user->college_name}}" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6 mb-3">
                                            <label for="text">Degree</label>
                                            <div class="input-icon"><input type="text" name="degree" value="{{@$user->degree}}" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" d-md-flex justify-content-md-start mb-3 mb-md-5">
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <div class="input-icon">
                                                <input type="text" name="course_name" value="{{@$user->course_name}}" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6 mb-3">
                                            ...
                                            <label class="uploadFile border rounded">
                                                ...
                                                <input type="file" class="inputfile form-control" name="course_document_img">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="portfolio_name" value="{{@$user->portfolio_name}}">
...
<script>
    ...
    dateControl.value = `{{ date('Y-m-d',strtotime(@$user->book_from)) }}`;
    dateControl.value = `{{ date('Y-m-d',strtotime(@$user->book_to)) }}`;
