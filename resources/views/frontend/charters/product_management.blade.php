                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <button class="nav-link active me-3" id="pills-profile-tab" data-bs-toggle="pill"
                              ...
                              aria-controls="pills-profile" aria-selected="true">Product Management</button>
                      ...
                      <form action="{{ route('productUpload') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="input-groups mb-3">
                            <label>Delivory Option 
                                <button type="button" class="question-mark ms-1" data-toggle="tooltip" data-placement="top" title="How fer are you willing to ship your product(s)">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                            ...
                                            <td>
                                                ...
                                                <i class="fa fa-cloud-upload upload-icon-account-1-table" aria-hidden="true"></i>
                                            ...
                                            <td>
                                                <div class="table-tag">
                                                    <ul class="list-unstyled mb-0" style="display: flex">
                                                        ...
                                                        <li>{{ $item->name }}<a href="" class="close-btn-tab"><i class="fa fa-times" aria-hidden="true"></i> </a></li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                            </td>
