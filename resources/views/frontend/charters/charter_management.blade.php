                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                          <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill"
                              ...
                              aria-selected="false">Upload Charter</button>
                      </li>
                  </ul>
                          ...
                          aria-labelledby="pills-home-tab">
                            <div class="row gx-2">
                              <div class="col-12 col-md-6">
                                  ...
                                  <input type="text" name="charter_name" class="form-control mb-3 p-2" id="exampleInputEmail1"
                                      aria-describedby="emailHelp">
                              </div>
                              <div class="col-12 col-md-6">
                                  <label for="exampleInputEmail1">Charter Type</label>
                                  <select class="form-select mb-3 py-2" aria-label="Default select example" name="charter_type"
                                      id="select-products">
                          ...
                          <div class="row gx-2">
                                  ...
                                  <div class="row gx-2">
                                      <div class="col-12 col-md-8">
                                          <div class="input-group flex-nowrap mb-3">
                                              ...
                                              <input type="text" name="deposit" class="form-control custom-input py-2"
                                                  aria-label="Username" aria-describedby="addon-wrapping">
                                          </div>
                                      </div>
                                      <div class="col-12 col-md-4">
                                          <p class="mb-3 mb-md-0">Leave blank for no deposit</p>   
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="col-12 col-md-6">
                                  ...
                                  <div class="row gx-2">
                                      ...
                                      <div class="col-12 col-md-6">
                                          <select class="form-select mb-3 py-2"
                              ...
                              <div class="text-area">
                                  ...
                                  <textarea class="form-control mb-4" placeholder=""
                              ...
                              <div class="row gx-2">
                                  ...
                                  <div class="col-12 col-lg-6">
                                      <div class="row gx-2">
                                          ...
                                          <div class="col-12 col-md-6">
                                              <div class="input-group mb-3">
                                                  <button
                                                      class="btn btn-outline-secondary dropdown-toggle btn-font"
                                          ...
                                          <div class="d-grid d-md-flex justify-content-md-end mb-3 mb-md-4">
                                  ...
                                  <div class="form-group mb-3">
                                      <label for="city_tag">Tags</label>
                                          <ul class="tags list-unstyled border d-flex flex-wrap rounded mb-0">
                                          ...
                                          <label>Delivory Option</label>
                                              <div class="input-type-check d-flex flex-wrap">
                                                  <div class="form-check">
                                                      ...
                                                      <label class="form-check-label pb-0" for="flexCheckDefault">
                                                          Global
                                                      </label>
                                                    </div>
                                                    <div class="form-check">
                                                      <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked">
                                                      <label class="form-check-label pb-0" for="flexCheckChecked">
                                                          National
                                                      </label>
                                                    </div>
                                                    <div class="form-check">
