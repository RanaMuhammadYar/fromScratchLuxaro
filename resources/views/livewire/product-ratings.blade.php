                        ...
                        @auth
                            ...
                            @if($hideForm != true)
                                <form wire:submit.prevent="rate()">
                                    ...
                                    <div class="block">
                                        <button type="submit" class="w-half px-3 py-4 font-medium text-white bg-blue-600 rounded-lg">Save Changes</button>
                                        @auth
                                            @if($currentId)
                                                <button type="submit" class="w-half px-3 py-4 mt-4 font-medium text-white bg-red-400 rounded-lg" wire:click.prevent="delete({{ $currentId }})" class="text-sm cursor-pointer">Delete</button>
                                            @endif
                                        @endauth
                                    </div>
                                </form>
